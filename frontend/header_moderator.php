...
<div class="container-fluid" style="background-color: #fff;">
	<div class="row">
	  ...
	  <div class="col-2">
		<div id="head-right">
			<button class="btn btn-default button-system" type="button">Панель</button>
				...
				<ul class="dropdown-menu">
				  ...
				  <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu" id="m1">
					  <li><a tabindex="-1" class="dropdown-item" href="#">Новий запис</a></li>
					  <li><a tabindex="-1" class="dropdown-item" href="#">Тип пам'яті</a></li>
					</ul>
				  </li>
				  ...
				  <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu" id="m2">
					  <li><a tabindex="-1" class="dropdown-item" href="#">Новий запис</a></li>
					  <li><a tabindex="-1" class="dropdown-item" href="#">Сокет</a></li>
					</ul>
				  </li>
				  ...
				  <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu" id="m4">
					  <li><a tabindex="-1" class="dropdown-item" href="#">HDD</a></li>
				  ...
				  <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu" id="m6">
					  <li><a tabindex="-1" class="dropdown-item" href="#">Новий запис</a></li>
					  <li><a tabindex="-1" class="dropdown-item" href="#">Підключення до материнської плати</a></li>
					</ul>
				  </li>
				</ul>
		  </li>
